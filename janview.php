    ...
    <div class="page">
        <div class="container">
            <div class="row">
                ...
                <h3>Monthly Bill Payments for Month January</h3>
		        <h4>First Half</h4>
		        <table class="table">
                    <thead>
                        <tr>
...
require 'inc/dbh.php';
	...
	$sql = $pdo->query("SELECT * FROM jan WHERE more = 0");
		foreach ($sql as $row) {
?>
                    ...
                    <form class="upform" action="process.php" method="POST">
                        ...
                        <input type="submit" name="submit_jan" value="+"></form></td>
                    </tr>
<?php } ?>
                    </tbody>
                </table>
...
`dtpaid` `notes` `more`
*/
$sql = $pdo->query("SELECT * FROM jan WHERE more = 1");
	foreach ($sql as $row) {
?>
